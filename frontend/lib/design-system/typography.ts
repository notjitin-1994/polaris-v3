...
export const textDecoration = {
  ...
  gradientSecondary: 'bg-gradient-to-r from-secondary to-secondary-light bg-clip-text text-transparent',
  gradientRainbow: 'bg-gradient-to-r from-red-500 via-primary to-secondary bg-clip-text text-transparent',
} as const;
...
export const magazineLayouts = {
  // Drop caps
  dropCap: 'first-letter:text-7xl first-letter:font-bold first-letter:float-left first-letter:mr-2 first-letter:mt-1 first-letter:font-serif',
