...
export { springPresets, orchestratedEntrance, sectionTransitions, itemAnimations, microInteractions } from './animations';
...
export const componentStyles = {
  ...
  button: {
    ...
    variants: {
      ...
      glass: 'bg-white/[0.08] backdrop-blur-md border border-white/[0.12] text-white hover:bg-white/[0.12]',
    },
  ...
  card: {
    ...
    variants: {
      ...
      gradient: 'bg-gradient-to-br from-primary/[0.08] to-secondary/[0.08] border border-white/[0.1]',
    },
  },
  ...
  input: {
    ...
    variants: {
      default: 'bg-background border border-neutral-300 focus:border-primary focus:ring-2 focus:ring-primary/20',
      glass: 'bg-white/[0.06] backdrop-blur-md border border-white/[0.1] focus:border-primary/50 focus:bg-white/[0.08]',
      filled: 'bg-neutral-100 border-transparent focus:bg-background focus:border-primary focus:ring-2 focus:ring-primary/20',
    },
