...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  try {
    ...
    const isBot =
      /bot|crawler|spider|facebook|twitter|slack|discord|linkedin|whatsapp|preview|embedly|quora|pinterest|reddit|google|bing|yahoo|duckduck|baidu|yandex|sogou|exabot|ia_archiver/.test(
        ua
      );
