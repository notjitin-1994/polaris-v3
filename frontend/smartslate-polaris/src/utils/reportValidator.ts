 ...
 */
export function repairNAReport(
  report: any,
  fallbackData?: {
    objectives?: string;
    audience?: string;
  ...
  if (!repaired.summary) {
    ...
    repaired.summary.problem_statement =
      repaired.summary.problem_statement || fallbackData?.objectives || 'Learning initiative';
...
export function extractJsonFromText(text: string): string {
  ...
  cleaned = cleaned.replace(/<analysis>[\s\S]*?<\/analysis>/gim, '');
