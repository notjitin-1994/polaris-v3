...
export function GoogleOAuthButton() {
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={loading}
      className="pressable inline-flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-900 transition hover:bg-slate-50"
    >
