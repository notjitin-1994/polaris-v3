    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-white/70">
          Tell us your comfort level. We will tailor the flow and the final starmap accordingly.
        </p>
      </div>
      ...
      <div className="flex items-center justify-end gap-2">
        <button
          ...
          onClick={onNext}
          disabled={!canNext}
          className={`rounded-lg border px-4 py-2 ${canNext ? 'border-primary-400 text-primary-200 hover:bg-primary-400/10' : 'cursor-not-allowed border-white/15 text-white/60 opacity-40'}`}
        >
          Continue
        </button>
      </div>
