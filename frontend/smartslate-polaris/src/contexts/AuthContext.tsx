        ...
        if (mounted) {
          ...
          try {
            if (import.meta.env.DEV)
              setUserContext(
                currentSession?.user
                  ? { id: currentSession.user.id, email: currentSession.user.email || undefined }
                  : null
              );
          } catch {}
        }
    ...
    const {
      ...
      try {
        if (import.meta.env.DEV)
          setUserContext(
            newSession?.user
              ? { id: newSession.user.id, email: newSession.user.email || undefined }
              : null
          );
      } catch {}
