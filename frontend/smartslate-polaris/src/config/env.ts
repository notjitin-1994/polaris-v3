...
export const env = {
  ...
  perplexityApiKey:
    read('VITE_PERPLEXITY_API_KEY') || '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',
  perplexityBaseUrl: read('VITE_PERPLEXITY_BASE_URL') || 'https://api.perplexity.ai',
  perplexityModel: read('VITE_PERPLEXITY_MODEL') || 'sonar',
  perplexityGreetingModel:
    read('VITE_PERPLEXITY_GREETING_MODEL') || read('VITE_PERPLEXITY_MODEL') || 'sonar',
