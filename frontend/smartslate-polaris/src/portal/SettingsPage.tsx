...
export function SettingsPage() {
  ...
  return (
    <div className="animate-fade-in-up mx-auto max-w-4xl space-y-4 px-4 py-6">
      <SectionCard title="Avatar" description="Your profile picture.">
        <div className="flex items-center gap-4">
          <span className="inline-flex h-16 w-16 items-center justify-center overflow-hidden rounded-full border border-white/10 bg-white/5">
            {getAvatarUrl(user) ? (
              <img
