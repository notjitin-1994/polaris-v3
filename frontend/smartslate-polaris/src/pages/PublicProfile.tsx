    ...
    >
      {showImg ? (
        ...
        <span className={textClass}>
          {user
            ? getUserInitial(user)
            : (fallbackInitial || 'U').toString().trim().charAt(0).toUpperCase()}
        </span>
      )}
    </span>
  );
...
export function PublicProfile() {
  ...
  if (loading) {
    return (
      <div className="flex min-h-screen w-full items-center justify-center bg-[rgb(var(--bg))] text-[rgb(var(--text))]">
        <div className="text-center">
          <div className="border-primary-400 mx-auto mb-4 h-8 w-8 animate-spin rounded-full border-2 border-t-transparent"></div>
  ...
  return (
    <div className="relative min-h-screen w-full bg-[rgb(var(--bg))] text-[rgb(var(--text))]">
      ...
      <header className="relative sticky top-0 z-20 overflow-hidden border-b border-white/10 bg-[rgb(var(--bg))]/80 backdrop-blur-xl">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex flex-col items-start">
              ...
              <p className="text-primary-400 -mt-1 text-sm font-medium">Professional Profile</p>
            </div>
            <a
              href="https://app.smartslate.io/"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-secondary-500 hover:bg-secondary-600 rounded-lg p-2 text-white transition-colors"
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 py-8">
        <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-6 shadow-2xl backdrop-blur-xl sm:p-8">
          <main className="space-y-8">
                ...
                <div className="flex flex-col items-center sm:items-start">
                  <div className="relative">
                    <UserAvatar
                      ...
                      fallbackInitial={displayName || username || 'User'}
                    />
                  ...
                  <div className="mb-4 space-y-3">
                    {((jobTitle && shareJobTitle) || (company && shareCompany)) && (
                      <div className="flex flex-wrap gap-2 text-sm">
                        {jobTitle && shareJobTitle && (
                          <span className="text-white/90">{jobTitle}</span>
                        )}
                        {jobTitle && shareJobTitle && company && shareCompany && (
            ...
            <footer className="relative z-10 mt-12 border-t border-white/10 pt-8 text-center">
              <div className="mb-4 flex flex-col items-center justify-center">
                <img
                  src="/images/logos/logo.png"
                  alt="Smartslate"
                  className="mb-2 h-6 w-auto opacity-60"
                />
                <span className="text-sm text-white/60">Powered by Smartslate</span>
              </div>
