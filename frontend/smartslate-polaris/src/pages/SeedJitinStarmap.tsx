...
5. Begin exemplar collection and curation`;
        ...
        const { data, error } = await saveSummary({
          ...
          stage1_answers: {
            requester_name: 'Jitin Nair',
            requester_role: 'Founder',
            requester_department: 'Executive',
            requester_email: 'jitin@smartslate.io',
          },
          stage2_answers: {
            org_name: 'Smartslate',
            org_industry: 'Technology',
            org_size: '11-50',
            org_headquarters: 'India',
            org_website: 'https://smartslate.io',
          },
          stage3_answers: {
            project_objectives: 'Scale enablement with measurable impact',
            project_budget_range: '$50k-$100k',
          },
          stage2_questions: [],
          stage3_questions: [],
