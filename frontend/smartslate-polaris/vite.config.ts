...
export default defineConfig(({ mode }) => {
  ...
  if (!process.env.PERPLEXITY_API_KEY && PERPLEXITY_API_KEY)
    process.env.PERPLEXITY_API_KEY = PERPLEXITY_API_KEY;
  if (!process.env.VITE_PERPLEXITY_API_KEY && PERPLEXITY_API_KEY)
    process.env.VITE_PERPLEXITY_API_KEY = PERPLEXITY_API_KEY;
  if (!process.env.PERPLEXITY_BASE_URL && PERPLEXITY_BASE_URL)
    process.env.PERPLEXITY_BASE_URL = PERPLEXITY_BASE_URL;
  if (!process.env.VITE_PERPLEXITY_BASE_URL && PERPLEXITY_BASE_URL)
    process.env.VITE_PERPLEXITY_BASE_URL = PERPLEXITY_BASE_URL;
      ...
      rollupOptions: {
        output: {
          manualChunks: {
            ...
            // Separate services
            services: ['./src/services/api/llmService.ts', './src/services/api/baseClient.ts'],
            // Separate animations
            animations: ['./src/components/SwirlField.tsx', './src/components/StaticSwirls.tsx'],
          },
