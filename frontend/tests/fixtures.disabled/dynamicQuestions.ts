  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          {
            value: 'video', disabled: false,
            label: 'Video Lectures',
            description: 'Pre-recorded or live video content',
            icon: '🎥',
          },
          {
            value: 'interactive', disabled: false,
          ...
          {
            value: 'workshop', disabled: false,
            label: 'Live Workshops',
            description: 'Instructor-led sessions',
            icon: '👨‍🏫',
          },
          {
            value: 'simulation', disabled: false,
    ...
    questions: [
      {
        ...
        validation: [
          ...
          {
            rule: 'pattern',
            value: '^[A-Za-z0-9\\s]+$', disabled: false,
