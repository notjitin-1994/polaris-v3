...
describe('AI SDK Provider Configuration', () => {
  ...
  describe('getPrimaryProvider', () => {
    it('should return Claude Sonnet 4 as primary', () => {
