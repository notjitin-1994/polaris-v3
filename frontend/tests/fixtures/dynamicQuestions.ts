...
export const validDynamicQuestions: Section[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { value: "cognitive", label: "Cognitive (Knowledge)", icon: "🧠" },
          { value: "psychomotor", label: "Psychomotor (Skills)", icon: "✋" },
          { value: "affective", label: "Affective (Attitudes)", icon: "❤️" },
          { value: "interpersonal", label: "Interpersonal (Social)", icon: "👥" }
        ],
        validation: [
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { value: "yes", label: "Yes, accommodations needed" },
          { value: "no", label: "No accommodations needed" }
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        validation: [
          { rule: "required", message: "Launch date is required" }
        ]
      }
    ]
  },
    ...
    questions: [
      {
        ...
        options: [
          { value: "pre_assessment", label: "Pre-assessments" },
          { value: "formative", label: "Formative (During Learning)" },
          { value: "summative", label: "Summative (End of Module)" },
    ...
    questions: [
      {
        ...
        options: [
          { value: "engagement", label: "Low Engagement Risk" },
          { value: "technical", label: "Technical Challenges" },
          { value: "time", label: "Time Constraints" },
          { value: "budget", label: "Budget Limitations" },
          { value: "culture", label: "Cultural Resistance" },
    ...
    questions: [
      {
        ...
        options: [
          { value: "yes", label: "Yes, time-sensitive" },
          { value: "no", label: "No, flexible timeline" }
        ]
      },
      {
        id: "q2_s10",
...
export const edgeCaseDynamicQuestions: Section[] = [
  {
    ...
    questions: [
      {
        id: "q1_edge",
        label: "Very long question label that tests the UI rendering capabilities and ensures that extremely verbose questions are handled properly without breaking the layout or causing text overflow issues in the dynamic questionnaire interface",
        type: "text",
        required: true,
        placeholder: "This placeholder text is also quite long to test edge cases",
        helpText: "This help text provides extensive guidance that might span multiple lines and includes various special characters like & < > \" ' and even emojis 🎯 to ensure proper escaping",
        validation: [
          { rule: "required", message: "This field is required" },
          { rule: "minLength", value: 1, message: "Minimum 1 character" },
          { rule: "maxLength", value: 10000, message: "Maximum 10000 characters" },
          { rule: "pattern", value: "^[A-Za-z0-9\\s]+$", message: "Only alphanumeric characters allowed" }
        ]
      },
      {
        id: "q2_edge",
