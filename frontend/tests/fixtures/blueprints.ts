...
export const validBlueprint: BlueprintJSON = {
    ...
    objectives: [
      {
        ...
        description: "Develop expertise in consultative selling techniques including active listening, questioning strategies, and solution mapping",
      ...
      },
      {
        ...
        description: "Enhance ability to identify and document customer pain points, requirements, and decision criteria",
      ...
      },
      {
        ...
        description: "Achieve expert-level understanding of technical product features and integration capabilities",
  ...
  instructional_strategy: {
    overview: "The program employs a blended learning approach combining self-paced digital content with instructor-led workshops and peer collaboration. The strategy emphasizes practical application through role-playing, case studies, and real customer scenarios. Microlearning principles ensure content is digestible and immediately applicable.",
    modalities: [
      {
        type: "Self-paced online modules",
        rationale: "Provides flexibility for busy sales professionals and ensures consistent foundational knowledge",
        allocation_percent: 40,
        tools: ["Canvas LMS", "Articulate 360", "Loom"]
      },
      {
        type: "Virtual instructor-led workshops",
        rationale: "Enables real-time practice, feedback, and peer learning across geographic locations",
        allocation_percent: 30,
        tools: ["Zoom", "Miro", "Mentimeter"]
      },
      {
        type: "On-the-job application",
        rationale: "Reinforces learning through immediate real-world practice with actual customers",
    ...
    cohort_model: "Learners progress in cohorts of 15-20 to foster collaboration and healthy competition. Each cohort includes a mix of experience levels to facilitate mentoring.",
    ...
    modules: [
      {
        ...
        description: "Introduction to consultative selling methodology and mindset shift from product to solution focus",
        topics: [
        ...
        assessment: {
          ...
          description: "Multiple choice quiz on concepts and recorded role-play demonstrating active listening"
        }
      },
      {
        module_id: "m2",
  ...
  assessment_strategy: {
    overview: "Multi-faceted assessment approach combining knowledge validation, skill demonstration, and performance measurement. Emphasis on practical application and real-world results rather than theoretical knowledge alone.",
    kpis: [
      {
    ...
    risks: [
      {
        ...
        probability: "Medium",
        impact: "High",
        mitigation_strategy: "Implement flexible scheduling, microlearning modules, and manager support agreements. Track engagement weekly and intervene early with at-risk learners."
      },
      {
        risk: "Technology platform issues",
        probability: "Low",
        impact: "Medium",
        mitigation_strategy: "Conduct thorough platform testing, maintain backup delivery methods, and ensure 24/7 technical support during critical periods."
      },
      {
        risk: "Resistance to behavior change",
        probability: "Medium",
        impact: "Medium",
        mitigation_strategy: "Secure executive sponsorship, share early success stories, implement peer recognition program, and tie completion to performance reviews."
      },
      {
        risk: "Budget overrun",
        probability: "Low",
        impact: "High",
        mitigation_strategy: "Maintain 10% contingency fund, phase content development, monitor expenses weekly, and have pre-approved scope reduction options."
      }
    ],
    contingency_plans: [
...
export const minimalBlueprint: BlueprintJSON = {
  ...
  target_audience: {
    demographics: {
      ...
      department_distribution: [
        { department: "General", percentage: 100 }
      ]
    },
    learning_preferences: {
      modalities: [
        { type: "Mixed", percentage: 100 }
      ]
    },
    displayType: "infographic"
  },
  ...
  resources: {
    human_resources: [
      { role: "Trainer", fte: 0.1, duration: "1 month" }
    ],
    tools_and_platforms: [
      { category: "LMS", name: "Basic LMS", cost_type: "Free" }
    ],
    budget: {
      currency: "USD",
      items: [
        { item: "Training", amount: 1000 }
      ],
      total: 1000
    },
    displayType: "table"
