  ...
  return (
    <div className="space-y-2">
      ...
      <div className="group animate-fade-in-up relative">
        <input
          className="focus:ring-primary focus:border-primary w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 pr-12 text-sm text-white placeholder-white/40 ring-0 transition outline-none focus:ring-[1.2px]"
