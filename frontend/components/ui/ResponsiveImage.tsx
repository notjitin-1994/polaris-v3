...
export function ResponsiveImage({
  ...
  if (hasError) {
    return (
      <div
        className={cn(
          "bg-neutral-100 border border-neutral-200 rounded-lg flex items-center justify-center",
          className
        )}
        style={{ width, height }}
 ...
 */
function generateImageUrl(baseUrl: string, options: { w?: number; h?: number; q?: number; f?: string }): string {
