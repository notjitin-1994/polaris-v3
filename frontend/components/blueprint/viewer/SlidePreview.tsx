...
export function SlidePreview({ slideId, colorTheme, icon: Icon }: SlidePreviewProps): React.JSX.Element {
  ...
  const previewPatterns: Record<string, React.ReactNode> = {
        ...
        <div className="grid w-full grid-cols-2 gap-1.5">
          {[0, 1, 2, 3].map((i) => (
            <motion.div
              ...
              style={{ borderColor: colorTheme.border, backgroundColor: colorTheme.bg }}
            >
              <div className="h-0.5 w-1/3 rounded" style={{ backgroundColor: colorTheme.primary, opacity: 0.5 }} />
              <motion.div 
            ...
            >
              ...
              <div className="flex items-center gap-0.5">
                <motion.div 
                  ...
                  transition={{ duration: 2.5, ease: easing.bounce, repeat: Infinity, delay: i * 0.3 }}
                />
                <div className="h-0.5 w-2 rounded" style={{ backgroundColor: colorTheme.light, opacity: 0.4 }} />
              </div>
              {/* Title */}
              <div className="h-0.5 w-full rounded" style={{ backgroundColor: colorTheme.primary, opacity: 0.5 }} />
    ...
    audience: (
      <div className="space-y-1 p-1.5 h-full">
        ...
        <div className="space-y-0.5">
          {[70, 85, 60].map((width, i) => (
            <div key={i} className="flex items-center gap-1">
              <div className="h-0.5 w-4 rounded" style={{ backgroundColor: colorTheme.light, opacity: 0.4 }} />
              <motion.div
          ...
          {[80, 65, 45].map((width, i) => (
            ...
            >
              <div className="flex justify-between items-center">
                <div className="h-0.5 w-8 rounded" style={{ backgroundColor: colorTheme.primary, opacity: 0.5 }} />
                <motion.div 
                  className="h-1 rounded" 
                  style={{ backgroundColor: colorTheme.primary }}
                  animate={{ width: ['10px', '12px', '10px'], opacity: [0.7, 0.9, 0.7] }}
                  transition={{ duration: 2.5, ease: easing.gentle, repeat: Infinity, delay: i * 0.4 }}
                />
              </div>
            </motion.div>
          ))}
          ...
          <div className="space-y-1.5">
            {[0, 1, 2].map((i) => (
              ...
              >
                ...
                <motion.div 
                  className="absolute -left-3.5 top-1 h-1.5 w-1.5 rounded-full border-2"
                  style={{ borderColor: colorTheme.primary, backgroundColor: colorTheme.bg }}
                  animate={{ 
                    scale: [1, 1.4, 1],
                    borderWidth: ['2px', '3px', '2px'],
                  }}
                  transition={{ duration: 3, delay: i * 0.8, ease: easing.bounce, repeat: Infinity }}
                />
                {/* Module card */}
                <div className="rounded border p-1" style={{ borderColor: colorTheme.border, backgroundColor: colorTheme.bg }}>
                  <motion.div 
                    className="h-0.5 rounded mb-0.5" 
                    style={{ backgroundColor: colorTheme.primary }}
                    animate={{ width: ['70%', '80%', '70%'], opacity: [0.6, 0.8, 0.6] }}
                    transition={{ duration: 3.5, ease: easing.gentle, repeat: Infinity, delay: i * 0.5 }}
                  />
                  <div className="h-0.5 w-1/2 rounded" style={{ backgroundColor: colorTheme.light, opacity: 0.4 }} />
                </div>
              </motion.div>
            ))}
          </div>
    ...
    resources: (
      <div className="grid h-full grid-cols-2 gap-1 p-1.5">
        ...
        <div className="flex items-center justify-center rounded border" style={{ borderColor: colorTheme.border, backgroundColor: colorTheme.bg }}>
          <motion.div
            animate={{ rotate: 360 }}
    ...
    assessment: (
      <div className="space-y-1 p-1.5 h-full">
        {/* Overview text */}
        <motion.div 
          className="h-0.5 w-full rounded mb-1" 
          style={{ backgroundColor: colorTheme.light }}
          ...
          {[0, 1, 2, 3].map((i) => (
            ...
            >
              <div className="flex justify-between mb-0.5">
                <div className="h-0.5 w-6 rounded" style={{ backgroundColor: colorTheme.light, opacity: 0.4 }} />
                <motion.div 
          ...
          <div className="space-y-1.5">
            {[0, 1, 2].map((i) => (
              <div key={i} className="relative ml-5">
                ...
                <motion.div
                  className="absolute -left-6 top-1 h-2 w-2 rounded-full border-2"
                  style={{ borderColor: colorTheme.primary, backgroundColor: colorTheme.bg }}
                  animate={{ 
                    scale: [1, 1.5, 1],
                    opacity: [0.5, 1, 0.5],
                ...
                >
                  <motion.div 
                    ...
                    transition={{ duration: 3.5, ease: easing.gentle, repeat: Infinity, delay: i * 0.7 }}
                  />
                  <div className="h-0.5 w-1/2 rounded" style={{ backgroundColor: colorTheme.light, opacity: 0.3 }} />
                </motion.div>
              </div>
            ))}
          </div>
            ...
            >
              <div className="flex justify-between items-center mb-0.5">
                <motion.div 
                  ...
                  transition={{ duration: 3.5, ease: easing.gentle, repeat: Infinity, delay: i * 0.3 }}
                />
                <div className="flex gap-0.5">
                  <motion.div 
                    ...
                    transition={{ duration: 2, ease: easing.smooth, repeat: Infinity, delay: i * 0.4 }}
                  />
                  <motion.div 
                    className="h-1 w-1 rounded-full" 
                    style={{ backgroundColor: colorTheme.primary }}
                    animate={{ opacity: [0.5, 0.9, 0.5] }}
                    transition={{ duration: 2, ease: easing.smooth, repeat: Infinity, delay: i * 0.4 + 0.3 }}
                  />
                </div>
              </div>
              <motion.div 
            ...
            >
              ...
              <div className="flex gap-1 mb-0.5">
                <motion.div 
                  ...
                  transition={{ duration: 2.5, ease: easing.gentle, repeat: Infinity, delay: i * 0.2 }}
                />
                <motion.div 
                  className="h-1 rounded" 
                  style={{ backgroundColor: colorTheme.primary }}
                  animate={{ width: ['14px', '18px', '14px'], opacity: [0.6, 0.85, 0.6] }}
                  transition={{ duration: 3, ease: easing.elastic, repeat: Infinity, delay: i * 0.4 }}
                />
              </div>
            </motion.div>
          ))}
    ...
    sustainability: (
      <div className="space-y-1 p-1.5 h-full">
        ...
        <motion.div 
          className="rounded border p-1 mb-1" 
          style={{ borderColor: colorTheme.border, backgroundColor: colorTheme.bg }}
