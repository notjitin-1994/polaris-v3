      ...
      {isOpen && (
        ...
        >
              ...
              <div className="flex h-14 items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 min-w-0 flex-1">
                  ...
                  <div className="flex items-center gap-2 min-w-0">
                    <div className="hidden sm:flex h-6 w-0.5 rounded-full bg-gradient-to-b from-primary to-primary/50" />
                    {/* Grid Icon */}
                    <div className="flex-shrink-0">
                      <GridIcon className="h-5 w-5 text-primary/80" />
                    </div>
                    <h1 
          ...
          <motion.div
            ...
            className="flex flex-1 w-full items-center justify-center overflow-y-auto px-12 py-12"
            onClick={(e) => e.stopPropagation()}
          >
