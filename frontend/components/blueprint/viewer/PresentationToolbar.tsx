...
export type PresentationTool = 'none' | 'laser' | 'pen' | 'highlighter' | 'eraser' | 'shape';
...
export function PresentationToolbar({
  ...
  const ToolButton = ({
    ...
    <motion.button
      ...
      className={cn(
        ...
        active
          ? 'border-primary/50 from-primary/20 to-primary/10 text-primary shadow-primary/20 bg-gradient-to-br shadow-lg'
          : 'hover:border-primary/30 border-white/10 bg-white/5 text-white/70 hover:bg-white/10 hover:text-white'
      )}
      title={label}
    >
  ...
  return (
    ...
    >
      <div className="relative mx-auto flex justify-center px-6 pt-8 pb-6">
        ...
        <div className="pointer-events-auto relative inline-flex items-center gap-2 overflow-hidden rounded-full border border-white/20 px-3 py-2.5 shadow-2xl backdrop-blur-2xl">
          ...
          {/* Subtle inner glow */}
          <div className="from-primary/5 to-secondary/5 absolute inset-0 rounded-full bg-gradient-to-t via-transparent" />
          ...
          <div className="relative z-10 flex items-center gap-2">
              ...
              <div className="relative">
                <motion.button
                  ...
                  className={cn(
                    'flex h-11 w-11 items-center justify-center rounded-xl border transition-all',
                    showColorPicker
                      ? 'border-primary/50 from-primary/20 to-primary/10 shadow-primary/20 bg-gradient-to-br shadow-lg'
                ...
                <AnimatePresence>
                  {showColorPicker && (
                    <motion.div
                      ...
                      className="absolute right-0 bottom-full mb-3 rounded-2xl border border-white/10 bg-gradient-to-br from-slate-900/98 to-slate-950/98 p-3 shadow-2xl backdrop-blur-2xl"
                    >
                          ...
                          <motion.button
                            ...
                            className={cn(
                              ...
                              drawingSettings.color === color.value
                                ? 'border-primary shadow-primary/30 ring-primary/20 shadow-lg ring-2'
              ...
              <div className="relative">
                <motion.button
                  ...
                  className={cn(
                    ...
                    showSizePicker
                      ? 'border-primary/50 from-primary/20 to-primary/10 shadow-primary/20 bg-gradient-to-br text-white shadow-lg'
                      : 'border-white/10 bg-white/5 text-white/70 hover:border-white/20 hover:bg-white/10 hover:text-white'
                  )}
                  title="Brush Size"
                >
                          ...
                          <motion.button
                            ...
                            className={cn(
                              ...
                              drawingSettings.size === size.value
                                ? 'border-primary/50 from-primary/20 to-primary/10 bg-gradient-to-r text-white shadow-md'
                                : 'border-white/10 bg-white/5 text-white/70 hover:border-white/20 hover:bg-white/10 hover:text-white'
                            )}
                          >
            ...
            <div className="flex items-center gap-1.5">
              ...
              {/* Grid View Button */}
              <ActionButton icon={Grid} onClick={onGridView} title="Slide Overview (G)" />
              ...
              <motion.button
                ...
                className={cn(
                  'flex h-11 w-11 items-center justify-center rounded-xl border transition-all',
                  isFullscreen
                    ? 'border-secondary/50 from-secondary/20 to-secondary/10 text-secondary shadow-secondary/20 bg-gradient-to-br shadow-lg'
                    : 'border-white/10 bg-white/5 text-white/70 hover:border-white/20 hover:bg-white/10 hover:text-white'
                )}
