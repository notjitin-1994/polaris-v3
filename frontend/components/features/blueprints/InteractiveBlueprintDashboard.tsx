...
export function InteractiveBlueprintDashboard({
    ...
    ({
      ...
      return (
        <motion.div
          ...
          className="group glass-card hover:shadow-primary/10 relative overflow-hidden rounded-2xl p-6 transition-all duration-300 hover:shadow-2xl"
        >
          <div
  ...
  return (
    ...
    >
      {/* Executive Summary removed - now shown in hero section */}
