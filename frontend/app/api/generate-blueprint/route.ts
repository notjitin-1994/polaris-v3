/**
 * Generate Blueprint API - Redirect to Claude Implementation
 *
 * This route has been migrated to use Claude AI instead of Ollama.
...
/**
 * Redirect all requests to the new Claude-based blueprint generation endpoint
 */
export async function POST(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    // Forward the request to the new Claude endpoint
...
export async function GET(): Promise<NextResponse> {
  return NextResponse.json({
    message: 'This endpoint has been migrated to use Claude AI',
