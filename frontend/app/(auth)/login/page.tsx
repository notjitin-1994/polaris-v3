            ...
            <section className="w-full flex items-stretch justify-center pt-0 sm:pt-1 md:pt-2 pb-0 sm:pb-6 h-full">
              <div className="relative w-full max-w-xl lg:max-w-none h-full glass rounded-2xl shadow-2xl">
                ...
                <div className="relative h-full flex flex-col px-4 sm:px-6 lg:px-8 py-4 sm:py-6 space-y-4">
                  ...
                  <AuthProvider>
                    <LoginForm className="[&>div>label]:text-white/80 [&>div>input]:glass-5 [&>div>input]:border [&>div>input]:glass-border-10 [&>div>input]:text-white [&>div>input]:rounded-lg [&>div>input]:p-3 [&>div>input]:w-full [&>div>input:focus]:outline-none [&>div>input:focus]:ring-2 [&>div>input:focus]:ring-[color:var(--primary-accent)]" />
                  </AuthProvider>
